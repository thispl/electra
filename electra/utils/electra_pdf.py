...
def get_electra_pdf(html, options=None, output: PdfWriter | None = None,doctype=None):
	...
	# if doctype:
	# 	frappe.log_error(title='si',message=doctype)
		# if doctype:
		# 	writer.append_pages_from_reader(reader)
		...
		# 		p = reader.getPage(i)
		# 		sn = frappe.get_doc(doctype,docname)
		# 		y_position = get_header_position(i,reader.getNumPages())
		# 		frappe.log_error(i,"page_no")
		# 		frappe.log_error(y_position,"y_position")
		# 		h_packet = io.BytesIO()
		# 		can = canvas.Canvas(h_packet, pagesize=letter)
		# 		t = can.beginText()
		# 		t.setTextOrigin(88,y_position)
		# 		t.setFont("Times-Roman",9)
		# 		total_amt = sn.customer
		# 		no_spaces = 165 - len(total_amt)
		# 		display_amt = ""
		# 		for x in range(no_spaces):
		# 			display_amt += " "
		# 		display_amt += str(sn.posting_date)
		# 		t.textLine(total_amt+display_amt)
		# 		t.textLine("")
		# 		invoice_no = ""
		# 		for x in range(168):
		# 			invoice_no += " "
		# 		invoice_no += sn.name
		# 		t.textLine(invoice_no)
		# 		t.textLine("")
		# 		delivery_no = ""
		# 		for x in range(168):
		# 			delivery_no += " "
		# 		if sn.delivery_note:
		# 			delivery_no += sn.delivery_note
		# 			t.textLine(delivery_no)
		# 			t.textLine("")

		# 			can.drawText(t)
		# 			can.save()
		# 			h_packet.seek(0)
		# 			new_pdf = PdfFileReader(h_packet)
		# 			p.mergePage(new_pdf.getPage(0))
		# 		else:
		# 			h_packet = io.BytesIO()
		# 			can = canvas.Canvas(h_packet, pagesize=letter)
		# 			t = can.beginText()
		# 			t.setTextOrigin(88,760)
		# 			t.setFont("Times-Roman",9)
		# 			total_amt = "Test"
		# 			no_spaces = 165 - len(total_amt)
		# 			display_amt = ""
		# 			for x in range(no_spaces):
		# 				display_amt += " "
		# 			display_amt += "2022-06-25"
		# 			t.textLine(total_amt+display_amt)
		# 			t.textLine("")
		# 			invoice_no = ""
		# 			for x in range(168):
		# 				invoice_no += " "
		# 			invoice_no += "KFTC-SI-2022-00001"
		# 			t.textLine(invoice_no)
		# 			t.textLine("")
		# 			delivery_no = ""
		# 			for x in range(168):
		# 				delivery_no += " "
		# 			delivery_no += "KFTC-SI-2022-00001"
		# 			t.textLine(delivery_no)
		# 			can.drawText(t)
		# 			can.save()
		# 			h_packet.seek(0)
		...
		# 			for x in range(no_spaces):
		# 				display_amt += " "
		# 			t.textLine(display_amt+total_amt)
		# 			t.textLine("")					
		# 			t.textLine("")
		# 			# t.textLine(display_amt+'60')	
								
		# 			amt_words = "QAR Six Thousand And Fifty only."
		# 			no_spaces = 126 - len(amt_words)+len(total_amt)
		# 			for x in range(no_spaces):
		# 				amt_words += " "
		# 			amt_words += total_amt
		# 			t.textLine(amt_words)
		# 			can.drawText(t)
		# 			can.save()
		# 			packet.seek(0)
