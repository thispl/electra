    ...
    if args.division:
        ...
        if salary_slip:
            ...
            for s in salary_slip :
                ...
                qid = frappe.get_value('Employee',{'employee':s.employee},['resident_id_no']) or 0
                visa_no = frappe.get_value('Employee',{'employee':s.employee},['visa_application_num']) or 0
                ...
                ws.append([i,qid,visa_no,name,bank_name,acc_no,freq,working_days,net_salary,basic_salary,ot_hrs,extra_inc,deductions,'Normal Payment',comment])
                i = i+1
        else:
