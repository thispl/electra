...
class StockAvailabilityReport(Document):
      ...
      def get_data(self):
            ...
            if stocks_query:
                  stocks = stocks_query
            data += '<table class="table table-bordered"><tr><th style="padding:1px;border: 1px solid black;background-color:#fe3f0c;" colspan=4><center>PRODUCT SEARCH</center></th></tr>'
            data += '<tr><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>Item Code</b></center></td><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;"><center><b></b></center></td></tr>'%(item,pso)
            data += '<tr><td style="padding:1px;border: 1px solid black;background-color:#6f6f6f;color:white;"><center><b>Item Name</b></center></td><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;"><center><b></b></center></td></tr>'%(frappe.db.get_value('Item',item,'item_name'),ppo)
            data += '<tr><td style="padding:1px;border: 1px solid black;background-color:#6f6f6f;color:white;"><center><b>Item Group</b></center></td><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;"><center><b>%s</b></center></td></tr>'%(group,cos,rate)
            data += '<tr><td style="padding:1px;border: 1px solid black;background-color:#6f6f6f;color:white;"><center><b>Item Price</b></center></td><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></tr>'%(price,ppoc)
            data += '<tr><td style="padding:1px;border: 1px solid black;background-color:#6f6f6f;color:white;"><center><b>Supplier Part No</b></center><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;"><center><b>%s</b></center></td></tr>'%(spn["supplier_part_no"],csp,(cspp_rate))
            data += '<tr><td style="padding:1px;border: 1px solid black;background-color:#6f6f6f;color:white;"><center><b>Description</b></center></td><td style="padding:1px;border: 1px solid black"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;color:white;background-color:#6f6f6f;"><center><b>%s</b></center></td><td style="padding:1px;border: 1px solid black;"><center><b>%s</b></center></td></tr>'%(des,cpp,(cppp_rate))
