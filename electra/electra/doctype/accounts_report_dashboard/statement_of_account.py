...
def make_xlsx(data, sheet_name=None, wb=None, column_widths=None):
    ...
    ws.append(header3 + [""] * 7)
    customer = frappe.db.get_value('Statement of Accounts Report', {"name": args.name}, ['customer'])
    ...
    for company in args.company_multiselect.split(','):
        ...
        for i in gl_entry:
            ...
            if i.voucher_type == "Sales Invoice":
                ...
                if cheque_no:
                    po_no = frappe.db.get_value("Advance Invoice", {"name": cheque_no}, "po_no") or frappe.db.get_value("Retention Invoice", {"name": cheque_no}, "po_no")
                else:
                    po_no = " "
