...
def get_columns(filters):
	columns = []
	columns += [_("Employee ID") + ":Link/Employee:120", _("Employee Name") + ":Data/:250",_("DoJ") + ":Date/:120",_("Year of Service") + ":Data/:300"]
	return columns
...
def calculate_gratuity(filters):
	...
	for emp in employees:
		...
		row = [emp.employee_number,emp.employee_name,emp.date_of_joining,yos]
		if diff.years > 1:
			data.append(row)
	return data