...
def get_columns(filters):
	...
	columns.append(_("Leave Without Pay")+ ':Data/:75')
	columns.append(_("Annual Leave")+ ':Data/:75')
	columns.append(_("Emergency Leave")+ ':Data/:75')
	columns.append(_("Marriage Leave")+ ':Data/:75')
	columns.append(_("Maternity Leave")+ ':Data/:75')
	columns.append(_("Medical Leave")+ ':Data/:75')
	columns.append(_("Sick Leave")+ ':Data/:75')
	columns.append(_("Hajj/Umrah")+ ':Data/:75')
	columns.append(_("Hajj Leave")+ ':Data/:75')
	columns.append(_("Casual Leave")+ ':Data/:75')
	columns.append(_("Compensatory Off")+ ':Data/:75')
	columns.append(_("Privilege Leave")+ ':Data/:75')
...
def get_data(filters):
	...
	for emp in employees:
		...
		dates = get_dates(filters.from_date,filters.to_date)
		row1 = [emp.name,emp.employee_name,emp.department,emp.designation,emp.date_of_joining]
		total_present = 0
		total_half_day = 0
		total_absent = 0
		total_onleave = 0
