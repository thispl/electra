...
def get_data(filters):
    ...
    for pb in project_budgets:
        ...
        cost_incurred_upto_previous_year = round(project_cost_till_date(project, last_year_start_date, last_year_end_date), 2) if last_year_start_date else 0
...
def get_conditions(filters):
    ...
    # if filters.get("from_date") and filters.get("to_date"):
        # conditions.append("""
        #     CASE 
        #         WHEN pb.date_of_budget IS NOT NULL 
        #             THEN pb.date_of_budget 
        #         ELSE DATE(pb.creation) 
