...
def execute(filters=None):
	...
	data = []
	columns += [
		_("Advance Invoice") + ":Link/Advance Invoice:200",
...
def get_order_data(filters):
	...
	query = """SELECT * FROM `tabAdvance Invoice` WHERE {conditions}""".format(conditions=conditions)
