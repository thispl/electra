...
def execute(filters=None):
    ...
    for item, item_dict in iteritems(item_details):
        ...
        valuation_rate = details.valuation_rate
        frappe.errprint(valuation_rate*range3)
        t3 = valuation_rate*range3
        row.extend([item_dict.get("total_qty"), average_age,
            range1,range1*valuation_rate, range2, range2*valuation_rate,range3, t3,range4,range4*valuation_rate,range5,range5*valuation_rate, range6, range6*valuation_rate,above_range6,above_range6*valuation_rate,
